...
//    $total=$_POST['total'];
    ...
    $insert=$pdo->prepare("insert into tbl_warehouse(w_name,	w_mobile,w_address,date,description) values(:t_name,:t_mobile,:t_address,:t_date,:t_description)");
    ...
    $insert->execute();
      ...
      header('location:warehousetoken.php'); 
