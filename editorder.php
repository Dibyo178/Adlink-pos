...
// 1) Get values from text feilds and from array in variables.
    ...
    $txt_subscription=$_POST['txtsubscription'];
    $txt_mobile=$_POST['txtnumber'];
    $txt_address=$_POST['txtaddress'];
    $txt_service=$_POST['txtservice'];
    ...
    <input type="text" class="form-control" name="txtcustomer" value="<?php echo $customer_name;?>" required>
                           ...
                           <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="txtnumber" value="<?php echo $mobile;?>"placeholder="Enter Customer Mobile" 
        ...
        <input type="text" class="form-control pull-right" id="datepicker" name="orderdate" value="<?php echo $order_date;?>" >
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="txtaddress" value="<?php echo $address;?>" placeholder="Enter Customer Address" 
...
-->
                 ...
                 <input type="text" class="form-control" value="<?php echo $discount?>" name="txtdiscount" id="txtdiscount" required>
                         ...
                         <span class="btn btn-primary" onclick="editDiscount()" >Add Dicount</span>
                         
                           <span style="background:#A40F0F;color:#fff;padding:7px;border:none;border-radius:5px;cursor:pointer" onclick="discount()">Reduce Discount</span>
                 ...
                 <input type="text" value="<?php echo $service?>" class="form-control" name="txtservice"  id="txtservice"  placeholder="Please Enter Service Charge">
                            </div>
                    ...
                    <input type="text" class="form-control" value="<?php echo $total?>" name="txttotal" id="txttotal" required readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" value="<?php echo $paid?>" name="txtpaid" onchange="paid()" id="txtpaid" required>
                            </div>
                        </div>
...
<input type="radio" name="rb" class="minimal-red" value="Check"<?php echo ($payment_type=='Check')?'checked':''?> >
                         ...
                         <div class="form-group">
                                ...
                                <select name="txtsubscription" id="txtsubscription">
                                    ...
                                    <option name="txtsubscription" value="Paid"<?php echo ($subscription=='Paid')?'selected':''?>>Paid</option>
                                    <option name="txtsubscription" value="Due"<?php echo ($subscription=='Due')?'selected':''?>>Due</option>
...
html+='<td><select class="form-control productid" name="productid[]" style="width: 250px";><option value="">Select Option</option><?php echo fill_product($pdo,''); ?> </select></td>';
 ...
 html+='<td><input type="text"  class="form-control deci" name="description"  ></td>';
