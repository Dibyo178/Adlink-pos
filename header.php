                    ...
                    <a href="#">
                     ...
                     while($row_message=mysqli_fetch_assoc($res_msg)){
                        ...
                        ?>
                            ...
                            <span><button id='<?php echo $row_message['id'] ; ?>'  class=" btndelete"><span class="glyphicon glyphicon-trash" style="color:#bf1e2e" style="font-size:10px" data-toggle="tooltip" title="Delete Message"></span></button></span>
                            </p>
...
-->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="addcustomer.php"><i class="fa fa-plus-square"></i>Add Customer</a></li>
            <li><a href="customerlist.php"><i class="fa fa-list"></i>Customer List</a></li>
          </ul>
        </li>
         
<!--
          <li><a href="addcustomer.php"><i class="fa fa-user"></i> <span>Add Customer</span></a></li>
          
           <li><a href="customerlist.php"><i class="fa fa-th-list"></i> <span>Customer List</span></a></li>
-->
...
<li><a href="tokenProduction.php"><i class="fa fa-plus" aria-hidden="true"></i>Create Token Production</a></li>
          
<li><a href="warehousetoken.php"><i class="fa fa-plus-circle" aria-hidden="true"></i>Create Token Warehouse</a></li>
...
<!--            <li><a href="createorder.php"><i class="fa fa-plus-circle"></i> <span>Createorder</span></a></li>-->
          ...
          <ul class="treeview-menu">
            <li><a href="warehousetokenlist.php"><i class="fa fa-list-ul"></i>Warehouse Token List</a></li>
           
          </ul>
        </li>
        
          
<!--           <li><a href="wearhouse.php"><i class="fas fa-warehouse"></i> <span>Warehouse</span></a></li>-->
         
         
         <li><a href="message.php"><i class="fa fa-envelope-open-o"></i> <span>Message</span></a></li>
