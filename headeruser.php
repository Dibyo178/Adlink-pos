...
if(!isset($_SESSION['userid'])){
  ...
  if($_SESSION['username']==""OR $_SESSION['role']=="grapic" OR $_SESSION['role']=="production" OR $_SESSION['role']=="	
warehouse" ){
...
<li><a href="warehousetoken.php"><i class="fa fa-plus-circle" aria-hidden="true"></i>Create Token Warehouse</a></li>          
         ...
         <li><a href="message1.php"><i class="fa fa-user-circle"></i> <span>Message</span></a></li>
<!--
        <li class="treeview">
