...
if(!isset($_SESSION['userid'])){
  ...
  if($_SESSION['username']=="" OR $_SESSION['role']=="User" OR $_SESSION['role']=="production" OR $_SESSION['role']=="	
warehouse"){
...
<!--            <li><a href="createToken.php"><i class="fa fa-plus-square" aria-hidden="true"></i>Create Token</a></li>-->
         ...
         <li><a href="message2.php"><i class="fa fa-user-circle"></i> <span>Message</span></a></li>
